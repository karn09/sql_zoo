...
-- 9 Show the name and population in millions and the GDP in billions for the countries of the 
...
-- 10 Show the per-capita GDP for those countries with a GDP of at least one trillion 
...
SELECT name,
 ...
 -- 12 Show the name and the continent - but substitute Eurasia for Europe and Asia; substitute America - for each country in North America or
  -- South America or Caribbean. Show countries beginning with A or B
 SELECT name,
